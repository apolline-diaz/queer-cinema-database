        ...
        <div className="px-10 py-5">
          ...
          <div className="flex flex-col mb-5">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl text-rose-500">Drame</h2>
              <Link
                href="/movies?genreId=13"
          ...
          <div className="flex flex-col mb-5">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl text-rose-500">Comédie</h2>
              <Link
          ...
          <div className="flex flex-col mb-5">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl text-rose-500">Documentaire</h2>
              <Link
          ...
          <div className="flex flex-col mb-5">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl text-rose-500">Années 90</h2>
              <Link
