  ...
  return (
    <div className="px-10 py-5 mb-5">
      ...
      <div className="">
        ...
        <div className="grid sm:grid-cols-3 grid-col-1 gap-5">
          <div className="rounded-2xl border border-rose-500 p-5">
            ...
            <p className="text-sm mb-3">
              ...
              <br /> Ce projet est né en France et donc le travail de recherche
              se fait depuis cette localisation et ce point de vue.
          ...
          <div className="rounded-2xl border border-rose-500 p-5">
            ...
            <p className="text-sm">
              ...
              correspond à nos envies ou à des sujets qui nous intéressent.{" "}
              <br />
              J&apos;ai donc choisi d&apos;indexer les films en leur associant
              des mots-clés et en utilisant d&apos;autres informations clés (le
              genre, l&apos;année de sortie, le pays de production, lea
              réalisateur-ice, le type).
              <br />
              Dans la page Catalogue, vous trouverez tous les films de la base
              de données. Ils sont classés du plus récent ajout au plus ancien.
              <br /> Il y a deux modes de recherche :
              <ul>
                <li>
                  - Recherche simple : tapez un titre de film ou tapez un
                  mot-clés
                </li>
                <li>
