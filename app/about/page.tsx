    ...
    <div className="px-10 py-5 mb-5">
      ...
      <div className="sm:w-3/4 w-full">
        ...
        <p className="text-sm mb-3">
          ...
          cinématographique, un discours, ou faisant partie d&apos;une certaine
        ...
        <p className="text-sm ">
          L&apos;indexation permet une recherche plus spécifique des films. Face
          à la masse de productions sur les sujets LGBTQI+ qui existe
          ...
          l&apos;année de sortie, le pays de production, lea réalisateur-ice, le
          type).
          <br />
