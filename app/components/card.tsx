        ...
        <div className="relative h-[180px] rounded-xl overflow-hidden">
          ...
          {userIsAdmin && (
            <button
              ...
              className="absolute top-2 right-2 z-10 bg-black bg-opacity-60 p-2 rounded-full text-pink-500 transition-all duration-300 ease-in-out opacity-100 visible hover:bg-pink-500 hover:text-white"
